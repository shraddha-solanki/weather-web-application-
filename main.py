...
api_key = '2b6e314d4d5f410bd658b89b814f2edc'
...
def get_weather(city):
    ...
    # Prevent IndexError or KeyError if no coordinates are returned
    if not location_data or len(location_data) == 0 or 'lat' not in location_data[0]:
